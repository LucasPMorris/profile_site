      ...
      <Link href='https://cal.com/lucas-morris/30min' target='_blank' data-aos-duration='1000'
        ...
        <div className='flex items-start justify-between gap-5'>
          <div className='space-y-1'>
            ...
            <p className='text-sm dark:text-neutral-300 md:text-base'>Let’s find some time to talk about anything</p>
          </div>
          <div className='rounded-full border-2 border-neutral-400 p-3 dark:border-teal-600 dark:text-neutral-100'><FiCalendar size={22} /></div>
        </div>
        <div className='flex items-center gap-5 text-sm dark:text-neutral-200'>
          <div className='flex items-center gap-2'><FiClock size={18} /><span>30 Minutes</span></div>
          <div className='flex items-center gap-2'><FiVideo size={18} /><span>Google Meet</span></div>
        </div>
      </Link>
    </div>
  );
