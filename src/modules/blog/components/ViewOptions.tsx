...
type ViewOptionsProps = { option: string; setViewOption: (option: string) => void; type: string; icon: JSX.Element; };
...
const ViewOptions = ({option, setViewOption, icon, type }: ViewOptionsProps) => {
  ...
  return (
    <button
      ...
      // TODO: decide if I want to use umami analytics event tracking
