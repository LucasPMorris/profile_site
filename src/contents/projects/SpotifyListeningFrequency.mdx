...
<div data-component="CallOut" data-header="Article Update Notice">
  ...
  I know that there are many things to fix amongst this work in progress, it is on my agenda (the floating menu will be fixed soon, if it annoys you, please check it out on a desktop).
