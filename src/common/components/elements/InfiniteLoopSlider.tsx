...
interface InfiniteLoopSliderProps { children: ReactNode; isReverse?: boolean; }
...
const StyledSlider = styled.div<{ isReverse: boolean }>`animation-direction: ${({ isReverse }) => (isReverse ? 'reverse' : 'normal')};`;
