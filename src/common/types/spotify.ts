...
export interface HeatmapDisplayProps { hourlyMap: Map<string, Map<string, number[]>>; weekdayMap: Map<string, { start: Date, counts: (number | null)[] }>; monthlyMap: Map<string, (number | null)[]>; maxPlays: number; }
